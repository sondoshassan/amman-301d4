...
// Student.prototype.greeting = () => `Hi, my name is ${this.name}`; // it gave me this: Hi, my name is
...
// because this bound to the parent scope in arrow function at this situation the parent scop of the arrow function is window
