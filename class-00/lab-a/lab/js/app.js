...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT Because the rando variable is local for while scope and we can't declare it outside this scope that's happen because I use let which make the variable more specific local for scope code while{}.
  console.log(viewed);
